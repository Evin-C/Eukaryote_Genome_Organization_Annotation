...
#SBATCH --job-name=tair_uniprot      # Job name
#SBATCH --output=tair_uniprot_%j.out # Standard output log
#SBATCH --error=tair_uniprot_%j.err  # Standard error log

...
lgd <- Legend(
    title = "Superfamily", at = c("Gypsy_LTR_retrotransposon", "Copia_LTR_retrotransposon", "CACTA_TIR_transposon", "Mutator_TIR_transposon", "hAT_TIR_transposon", "tRNA_SINE_retrotransposon", "L1_LINE_retrotransposon"),
    legend_gp = gpar(fill = c("green", "red", "blue", "magenta", "orange", "yellow2", "purple3"))
)
